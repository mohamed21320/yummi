...
function displayCategory(res) {
    ...
    for (let i = 0; i < res.categories.length; i++) {
        ...
        <div onclick = "callByCategory('${res.categories[i].strCategory}')" class="img-holder Category">
...
function displayArea(res) {
    ...
    for (let i = 0; i < res.meals.length; i++) {
        ...
        <div onclick = "displayAreaFood('${res.meals[i].strArea}')"  class="rounded-2 text-center area">
...
function displayIngredients(res) {
    ...
    for (let i = 0; i < 20; i++) {
        cartona += `<div class="col-md-3">
        <div onclick = "displayIngredientFood('${res.meals[i].strIngredient}')"  class="rounded-2 text-center Ingredients">
